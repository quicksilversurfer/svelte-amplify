...
<div class="relative isolate z-50 shadow-sm">
  <div class="bg-white py-5">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <button type="button" class="inline-flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" aria-expanded={isMenuOpen}
        on:click={toggleMenu}>
        Solutions
  ...
  -->
  {#if isMenuOpen}
  <div transition:fly={menuTransition} class="absolute inset-x-0 top-0 -z-10 bg-white pt-16 ring-1 shadow-lg ring-gray-900/5">
